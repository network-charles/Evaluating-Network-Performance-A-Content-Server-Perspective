'''
    ...
    3. Makes a GET request to https://ipwhois.io/documentation#tabs-format to obtain the geolocation information of each ipv4 address.
...
with open('c:/Users/Admin/Documents/Project/file.txt', 'r') as file:
    ...
    for idx, ipv4_address in enumerate(public_ipv4_addresses):
        ...
        json_doc = open('c:/Users/Admin/Documents/Project/Traceroutes/Top 20 Sites by Alexa/Using MTN/IP Geolocators/Using IPWhois API/Excel data/1/1x001.json', 'a')
