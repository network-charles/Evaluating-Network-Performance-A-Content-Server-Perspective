...
with open('c:/Users/Admin/Documents/Project/file.txt', 'r') as file:
    ...
    # Creating a file to save the text response of each API call to a JSON file.
    # The 'a' options appends each new response to the response to the end of the file.
